...
// RealmKeyStoreAESGenerated is the Schema for the RealmKeyStoreAESGenerateds API.
...
func init() {
	SchemeBuilder.Register(&RealmKeyStoreAESGenerated{}, &RealmKeyStoreAESGeneratedList{})
}
