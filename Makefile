...
PROJECT_REPO ?= github.com/trois-six/$(PROJECT_NAME)

export TERRAFORM_VERSION ?= 1.7.3
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/keycloaks/01-delete.yaml.tmpl.
